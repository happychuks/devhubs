...
const productSchema = z.object({
  ...
  productFile: z
    .string()
    .min(1, { message: "Please upload a zip of your project" }),
});
  ...
  const session = await stripe.checkout.sessions.create({
    ...
    success_url:
      process.env.NODE_ENV === "development"
        ...
        : "https://devhubs.vercel.app/payment/success",
    cancel_url:
      process.env.NODE_ENV === "development"
        ? "http://localhost:3000/payment/cancel"
        : "https://devhubs.vercel.app/payment/cancel",
  });
  ...
  const accountLink = await stripe.accountLinks.create({
    ...
    refresh_url:
      process.env.NODE_ENV === "development"
        ...
        : `https://devhubs.vercel.app/billing`,
    return_url:
      process.env.NODE_ENV === "development"
        ? `http://localhost:3000/return/${data?.connectedAccountId}`
        : `https://devhubs.vercel.app/return/${data?.connectedAccountId}`,
